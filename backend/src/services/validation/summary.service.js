async function getSummary(trustScore, riskLevel, hostname, companyName, checks) {
  try {
    const {
      whois,
      ssl,
    ...
    lines.push(
      `The company ${companyName} (${hostname}) received a Trust Score of ${trustScore.score}/100 and is classified as ${riskLevel} Risk.`
    );
